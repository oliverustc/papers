...
+ [原文链接](https://link.springer.com/chapter/10.1007/3-540-49649-1_14)
...
群签名的概念允许群体成员代表该群体匿名签署消息。然而，在发生争议的情况下，可以通过指定实体揭示签名发起者的身份。本文提出了一种新的群签名方案，非常适合大规模群体，即群体的公钥和签名的长度不依赖于群体的规模。我们基于RSA问题的变体所提出的解决方案比之前满足这些要求的方案更为高效。
